...
<div class="row">
        ...
        <div class="row"><h3 class="text-center">Reporte Mensual de Entrada</h3></div>

        </br>
        </br>
        <form class="form-horizontal" role="form" action="<c:url value="/repo_entrada_mensual" />" target="_blank">
            ...
            <div class="form-group">
                <div class="col-sm-offset-6 col-sm-10">
                    <button type="submit" class="btn btn-primary">Generar Reporte</button>
                      <a class="btn btn-danger" href="<c:url value="/index" />" role="button">Regresar Menú Principal</a>
                </div>
                
				<input type="hidden" value="${loggedinuser}" name="usuario"/>
				<input type="hidden" value="EntradasMensuales.jasper" name="nombre"/>
            </div>
	</form>
