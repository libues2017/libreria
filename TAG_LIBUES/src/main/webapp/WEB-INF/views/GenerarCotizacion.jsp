...
<div class="row">
        ...
        <div class="row"><h3 class="text-center">Comprobante de Cotizacion</h3></div>

        </br>
        </br>
        <form class="form-horizontal" role="form" action="<c:url value="/repo_cotizacion" />" target="_blank">
            ...
            <div class="form-group">
                <div class="col-sm-offset-6 col-sm-10">
                    <button type="submit" class="btn btn-primary">Imprimir Comprobante</button>
                    <a class="btn btn-danger" href="<c:url value="/cotizacion-list" />" role="button">Listar Cotizaciones</a>
                </div>
